...
export default function EventAttendessBuyView({ feature,buy,cost,loading }: Props) {
  return (
    <div className={classes.container}>
      ...
      {(typeof feature === 'boolean' && !feature && !loading) && (
        <>
          ...
          <AutoConfirmButton text={`débloquer (${cost} Dr.)`} textConfirm="C'est parti !" onClick={()=>buy()}/>
        </>
      )}
      <p>Prévoir le time</p>
    </div>
