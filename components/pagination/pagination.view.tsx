import { PaginationProps, PaginationResults } from "./pagination.type"
import styles from './pagination.module.css'
export const PaginationView: React.FC<PaginationProps & PaginationResults> = ({ pagination, previous, next, setPage }) => {
